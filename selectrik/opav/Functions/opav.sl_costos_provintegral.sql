-- Function: opav.sl_costos_provintegral(character varying)

-- DROP FUNCTION opav.sl_costos_provintegral(character varying);

CREATE OR REPLACE FUNCTION opav.sl_costos_provintegral(_multiservicio character varying)
...
ALTER FUNCTION opav.sl_costos_provintegral(character varying)
  OWNER TO postgres;
