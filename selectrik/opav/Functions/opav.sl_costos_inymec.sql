-- Function: opav.sl_costos_inymec(character varying)

-- DROP FUNCTION opav.sl_costos_inymec(character varying);

CREATE OR REPLACE FUNCTION opav.sl_costos_inymec(_multiservicio character varying)
...
ALTER FUNCTION opav.sl_costos_inymec(character varying)
  OWNER TO postgres;
