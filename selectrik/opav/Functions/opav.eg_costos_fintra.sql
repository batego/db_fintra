-- Function: opav.eg_costos_fintra(character varying)

-- DROP FUNCTION opav.eg_costos_fintra(character varying);

CREATE OR REPLACE FUNCTION opav.eg_costos_fintra(_multiservicio character varying)
...
ALTER FUNCTION opav.eg_costos_fintra(character varying)
  OWNER TO postgres;
