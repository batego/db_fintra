-- Function: opav.sp_crearordencs(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying)

-- DROP FUNCTION opav.sp_crearordencs(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying);

CREATE OR REPLACE FUNCTION opav.sp_crearordencs(_usuario character varying, _tiposolicitud character varying, _proveedor character varying, _descripcion character varying, _fechaentrega character varying, _direccionentrega character varying, _formapago character varying, _idbodega character varying)
	...
	if ( Sepuede > 0 ) then
		...
		INSERT INTO opav.sl_orden_compra_servicio(
		    ...
		    VALUES ('', 'FINV', OCS, _usuario, OCS, _Proveedor,
			    _TipoSolicitud::integer, _IdBodega::integer, _DireccionEntrega, _Descripcion, now(),
...
ALTER FUNCTION opav.sp_crearordencs(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying)
  OWNER TO postgres;
