-- Function: opav.eg_costos_provintegral(character varying)

-- DROP FUNCTION opav.eg_costos_provintegral(character varying);

CREATE OR REPLACE FUNCTION opav.eg_costos_provintegral(_multiservicio character varying)
...
ALTER FUNCTION opav.eg_costos_provintegral(character varying)
  OWNER TO postgres;
