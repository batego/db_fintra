-- Function: opav.sl_get_valor_cot_area(character varying, integer)

-- DROP FUNCTION opav.sl_get_valor_cot_area(character varying, integer);

CREATE OR REPLACE FUNCTION opav.sl_get_valor_cot_area(_id_solicitud character varying, area_ integer)
  RETURNS text AS
$BODY$
...
ALTER FUNCTION opav.sl_get_valor_cot_area(character varying, integer)
  OWNER TO postgres;
