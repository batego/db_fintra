-- Function: opav.dv_costos_provintegral()

-- DROP FUNCTION opav.dv_costos_provintegral();

CREATE OR REPLACE FUNCTION opav.dv_costos_provintegral()
...
ALTER FUNCTION opav.dv_costos_provintegral()
  OWNER TO postgres;
