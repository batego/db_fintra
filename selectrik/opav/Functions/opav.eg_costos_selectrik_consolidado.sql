-- Function: opav.eg_costos_selectrik_consolidado(character varying)

-- DROP FUNCTION opav.eg_costos_selectrik_consolidado(character varying);

CREATE OR REPLACE FUNCTION opav.eg_costos_selectrik_consolidado(_multiservicio character varying)
...
ALTER FUNCTION opav.eg_costos_selectrik_consolidado(character varying)
  OWNER TO postgres;
