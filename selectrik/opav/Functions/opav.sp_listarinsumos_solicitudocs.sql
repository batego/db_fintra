-- Function: opav.sp_listarinsumos_solicitudocs(character varying, character varying, character varying, character varying)

-- DROP FUNCTION opav.sp_listarinsumos_solicitudocs(character varying, character varying, character varying, character varying);

CREATE OR REPLACE FUNCTION opav.sp_listarinsumos_solicitudocs(idsolicitud character varying, _usuario character varying, _accion character varying, _codsol character varying)
...
ALTER FUNCTION opav.sp_listarinsumos_solicitudocs(character varying, character varying, character varying, character varying)
  OWNER TO postgres;
