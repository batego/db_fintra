-- Function: opav.eg_costos_selectrik(character varying)

-- DROP FUNCTION opav.eg_costos_selectrik(character varying);

CREATE OR REPLACE FUNCTION opav.eg_costos_selectrik(_multiservicio character varying)
...
ALTER FUNCTION opav.eg_costos_selectrik(character varying)
  OWNER TO postgres;
