-- Function: opav.sp_whatido(character varying, character varying, character varying, character varying, character varying, character varying)

-- DROP FUNCTION opav.sp_whatido(character varying, character varying, character varying, character varying, character varying, character varying);

CREATE OR REPLACE FUNCTION opav.sp_whatido(_usuario character varying, _idsolicitud character varying, tiposol character varying, bodegallevar character varying, _descripcion character varying, _fecha_entrega character varying)
...
ALTER FUNCTION opav.sp_whatido(character varying, character varying, character varying, character varying, character varying, character varying)
  OWNER TO postgres;
