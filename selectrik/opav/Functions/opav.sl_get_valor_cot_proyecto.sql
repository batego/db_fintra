-- Function: opav.sl_get_valor_cot_proyecto(character varying)

-- DROP FUNCTION opav.sl_get_valor_cot_proyecto(character varying);

CREATE OR REPLACE FUNCTION opav.sl_get_valor_cot_proyecto(_id_solicitud character varying)
  RETURNS text AS
$BODY$
...
ALTER FUNCTION opav.sl_get_valor_cot_proyecto(character varying)
  OWNER TO postgres;
