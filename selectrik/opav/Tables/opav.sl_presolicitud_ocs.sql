-- Table: opav.sl_presolicitud_ocs

-- DROP TABLE opav.sl_presolicitud_ocs;

CREATE TABLE opav.sl_presolicitud_ocs
(
  id serial NOT NULL,
  ...
  cod_solicitud_devolucion character varying(50) NOT NULL DEFAULT ''::character varying
)
WITH (
  OIDS=FALSE
);
ALTER TABLE opav.sl_presolicitud_ocs
  OWNER TO postgres;
