-- Table: opav.sl_orden_compra_servicio

-- DROP TABLE opav.sl_orden_compra_servicio;

CREATE TABLE opav.sl_orden_compra_servicio
(
  id serial NOT NULL,
  ...
  no_despacho character varying(20) DEFAULT ''::character varying
)
WITH (
  OIDS=FALSE
);
ALTER TABLE opav.sl_orden_compra_servicio
  OWNER TO postgres;
