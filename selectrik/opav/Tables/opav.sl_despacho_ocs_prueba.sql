-- Table: opav.sl_despacho_ocs_prueba

-- DROP TABLE opav.sl_despacho_ocs_prueba;

CREATE TABLE opav.sl_despacho_ocs_prueba
(
  id serial NOT NULL,
...
ALTER TABLE opav.sl_despacho_ocs_prueba
  OWNER TO postgres;
