-- Table: opav.sl_solicitud_ocs

-- DROP TABLE opav.sl_solicitud_ocs;

CREATE TABLE opav.sl_solicitud_ocs
(
  id serial NOT NULL,
  ...
  id_bodega integer,
  CONSTRAINT fk_sl_solicitud_sl_bodega FOREIGN KEY (id_bodega)
...
ALTER TABLE opav.sl_solicitud_ocs
  OWNER TO postgres;
