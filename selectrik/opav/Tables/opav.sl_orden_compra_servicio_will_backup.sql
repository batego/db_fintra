-- Table: opav.sl_orden_compra_servicio_will_backup

-- DROP TABLE opav.sl_orden_compra_servicio_will_backup;

CREATE TABLE opav.sl_orden_compra_servicio_will_backup
(
  id integer,
...
ALTER TABLE opav.sl_orden_compra_servicio_will_backup
  OWNER TO postgres;
