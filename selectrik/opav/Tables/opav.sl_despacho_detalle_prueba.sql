-- Table: opav.sl_despacho_detalle_prueba

-- DROP TABLE opav.sl_despacho_detalle_prueba;

CREATE TABLE opav.sl_despacho_detalle_prueba
(
  id serial NOT NULL,
...
ALTER TABLE opav.sl_despacho_detalle_prueba
  OWNER TO postgres;
