-- Table: opav.sl_solicitud_ocs_detalle

-- DROP TABLE opav.sl_solicitud_ocs_detalle;

CREATE TABLE opav.sl_solicitud_ocs_detalle
(
  id serial NOT NULL,
  ...
  CONSTRAINT fk_solocsdetalle FOREIGN KEY (id_solicitud_ocs)
      REFERENCES opav.sl_solicitud_ocs (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
)
WITH (
  OIDS=FALSE
);
ALTER TABLE opav.sl_solicitud_ocs_detalle
  OWNER TO postgres;
