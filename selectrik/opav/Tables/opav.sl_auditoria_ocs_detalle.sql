-- Table: opav.sl_auditoria_ocs_detalle

-- DROP TABLE opav.sl_auditoria_ocs_detalle;

CREATE TABLE opav.sl_auditoria_ocs_detalle
(
  id serial NOT NULL,
...
ALTER TABLE opav.sl_auditoria_ocs_detalle
  OWNER TO postgres;
