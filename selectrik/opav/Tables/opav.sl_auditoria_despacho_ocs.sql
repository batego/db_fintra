-- Table: opav.sl_auditoria_despacho_ocs

-- DROP TABLE opav.sl_auditoria_despacho_ocs;

CREATE TABLE opav.sl_auditoria_despacho_ocs
(
  id serial NOT NULL,
...
ALTER TABLE opav.sl_auditoria_despacho_ocs
  OWNER TO postgres;
