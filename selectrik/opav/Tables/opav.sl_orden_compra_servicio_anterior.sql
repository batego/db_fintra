-- Table: opav.sl_orden_compra_servicio_anterior

-- DROP TABLE opav.sl_orden_compra_servicio_anterior;

CREATE TABLE opav.sl_orden_compra_servicio_anterior
(
  id integer,
...
ALTER TABLE opav.sl_orden_compra_servicio_anterior
  OWNER TO postgres;
