-- Table: opav.sl_auditoria_despacho_detalle

-- DROP TABLE opav.sl_auditoria_despacho_detalle;

CREATE TABLE opav.sl_auditoria_despacho_detalle
(
  id serial NOT NULL,
...
ALTER TABLE opav.sl_auditoria_despacho_detalle
  OWNER TO postgres;
