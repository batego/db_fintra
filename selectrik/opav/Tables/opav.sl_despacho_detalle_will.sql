-- Table: opav.sl_despacho_detalle_will

-- DROP TABLE opav.sl_despacho_detalle_will;

CREATE TABLE opav.sl_despacho_detalle_will
(
  id serial NOT NULL,
...
ALTER TABLE opav.sl_despacho_detalle_will
  OWNER TO postgres;
