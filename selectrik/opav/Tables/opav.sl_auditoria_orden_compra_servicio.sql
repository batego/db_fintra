-- Table: opav.sl_auditoria_orden_compra_servicio

-- DROP TABLE opav.sl_auditoria_orden_compra_servicio;

CREATE TABLE opav.sl_auditoria_orden_compra_servicio
(
  id serial NOT NULL,
...
ALTER TABLE opav.sl_auditoria_orden_compra_servicio
  OWNER TO postgres;
