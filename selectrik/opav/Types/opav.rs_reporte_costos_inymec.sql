-- Type: opav.rs_reporte_costos_inymec

-- DROP TYPE opav.rs_reporte_costos_inymec;

CREATE TYPE opav.rs_reporte_costos_inymec AS
   (empresa text,
...
ALTER TYPE opav.rs_reporte_costos_inymec
  OWNER TO postgres;
