-- Table: fin.cxp_imp_item

-- DROP TABLE fin.cxp_imp_item;

CREATE TABLE fin.cxp_imp_item
(
  ...
  CONSTRAINT cxp_imp_item FOREIGN KEY (dstrct, proveedor, tipo_documento, documento)
...
ALTER TABLE fin.cxp_imp_item
  OWNER TO postgres;
COMMENT ON TABLE fin.cxp_imp_item
  IS 'Registra los impuestos de los items';
