-- Table: movimientos_cont_det_backup

-- DROP TABLE movimientos_cont_det_backup;

CREATE TABLE movimientos_cont_det_backup
(
...
ALTER TABLE movimientos_cont_det_backup
  OWNER TO postgres;
GRANT ALL ON TABLE movimientos_cont_det_backup TO postgres;
GRANT SELECT ON TABLE movimientos_cont_det_backup TO msoto;
