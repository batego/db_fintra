-- Table: tem_btg_not_ajust_apacheco_det_comp

-- DROP TABLE tem_btg_not_ajust_apacheco_det_comp;

CREATE TABLE tem_btg_not_ajust_apacheco_det_comp
(
...
ALTER TABLE tem_btg_not_ajust_apacheco_det_comp
  OWNER TO postgres;
