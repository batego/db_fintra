-- Table: movimientos_cont_backup

-- DROP TABLE movimientos_cont_backup;

CREATE TABLE movimientos_cont_backup
(
...
ALTER TABLE movimientos_cont_backup
  OWNER TO postgres;
GRANT ALL ON TABLE movimientos_cont_backup TO postgres;
GRANT SELECT ON TABLE movimientos_cont_backup TO msoto;
