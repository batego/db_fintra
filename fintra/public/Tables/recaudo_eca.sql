...
-- DROP TABLE recaudo_eca;

CREATE TABLE recaudo_eca
(
  id serial NOT NULL,
...
ALTER TABLE recaudo_eca
  OWNER TO postgres;
GRANT ALL ON TABLE recaudo_eca TO postgres;
GRANT SELECT ON TABLE recaudo_eca TO msoto;
