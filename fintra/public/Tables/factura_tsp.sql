...
-- DROP TABLE factura_tsp;

CREATE TABLE factura_tsp
(
...
ALTER TABLE factura_tsp
  OWNER TO postgres;
GRANT ALL ON TABLE factura_tsp TO postgres;
GRANT SELECT ON TABLE factura_tsp TO msoto;
