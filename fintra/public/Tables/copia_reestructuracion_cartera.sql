-- Table: copia_reestructuracion_cartera

-- DROP TABLE copia_reestructuracion_cartera;

CREATE TABLE copia_reestructuracion_cartera
(
  ...
  endoso_fenalco character varying(2),
...
ALTER TABLE copia_reestructuracion_cartera
  OWNER TO postgres;
GRANT ALL ON TABLE copia_reestructuracion_cartera TO postgres;
GRANT SELECT ON TABLE copia_reestructuracion_cartera TO msoto;
