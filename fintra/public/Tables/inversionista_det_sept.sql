-- Table: inversionista_det_sept

-- DROP TABLE inversionista_det_sept;

CREATE TABLE inversionista_det_sept
(
...
ALTER TABLE inversionista_det_sept
  OWNER TO postgres;
GRANT ALL ON TABLE inversionista_det_sept TO postgres;
GRANT SELECT ON TABLE inversionista_det_sept TO msoto;
