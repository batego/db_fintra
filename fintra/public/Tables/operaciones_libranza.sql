-- Table: operaciones_libranza

-- DROP TABLE operaciones_libranza;

CREATE TABLE operaciones_libranza
(
  id serial NOT NULL,
...
ALTER TABLE operaciones_libranza
  OWNER TO postgres;
GRANT ALL ON TABLE operaciones_libranza TO postgres;
GRANT SELECT ON TABLE operaciones_libranza TO msoto;
