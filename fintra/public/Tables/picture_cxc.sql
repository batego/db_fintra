...
-- DROP TABLE picture_cxc;

CREATE TABLE picture_cxc
(
...
ALTER TABLE picture_cxc
  OWNER TO postgres;
GRANT ALL ON TABLE picture_cxc TO postgres;
GRANT SELECT ON TABLE picture_cxc TO msoto;
