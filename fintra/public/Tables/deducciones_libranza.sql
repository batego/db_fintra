-- Table: deducciones_libranza

-- DROP TABLE deducciones_libranza;

CREATE TABLE deducciones_libranza
(
  id serial NOT NULL,
...
ALTER TABLE deducciones_libranza
  OWNER TO postgres;
GRANT ALL ON TABLE deducciones_libranza TO postgres;
GRANT SELECT ON TABLE deducciones_libranza TO msoto;
