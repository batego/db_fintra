-- Table: ex_historico_subclientes_ofertas

-- DROP TABLE ex_historico_subclientes_ofertas;

CREATE TABLE ex_historico_subclientes_ofertas
(
  ...
  idhist integer NOT NULL DEFAULT nextval('historico_subclientes_ofertas_idhist_seq'::regclass),
...
ALTER TABLE ex_historico_subclientes_ofertas
  OWNER TO postgres;
GRANT ALL ON TABLE ex_historico_subclientes_ofertas TO postgres;
GRANT SELECT ON TABLE ex_historico_subclientes_ofertas TO msoto;
