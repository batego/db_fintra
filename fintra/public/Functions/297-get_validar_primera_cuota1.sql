-- Function: get_validar_primera_cuota1(text, text)

-- DROP FUNCTION get_validar_primera_cuota1(text, text);

CREATE OR REPLACE FUNCTION get_validar_primera_cuota1(text, text)
  RETURNS boolean AS
$BODY$
declare
...
ALTER FUNCTION get_validar_primera_cuota1(text, text)
  OWNER TO postgres;
