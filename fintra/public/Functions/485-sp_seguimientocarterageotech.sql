-- Function: sp_seguimientocarterageotech(numeric, character varying, character varying)

-- DROP FUNCTION sp_seguimientocarterageotech(numeric, character varying, character varying);

CREATE OR REPLACE FUNCTION sp_seguimientocarterageotech(periodoasignacion numeric, unidadnegocio character varying, agenteext character varying)
	...
	ELSE
		...
		FOR CarteraGeneral IN
			...
			where fca.factura_geotech = fcg.documento
				...
				and fcg.reg_status = ''
				and fcg.dstrct = 'GEOT'
				and fcg.tipo_documento = 'FACN' --and fcg.nit = '800010319'
...
ALTER FUNCTION sp_seguimientocarterageotech(numeric, character varying, character varying)
  OWNER TO postgres;
