-- Function: dv_guardar_caracterizacion_clientes(character varying)

-- DROP FUNCTION dv_guardar_caracterizacion_clientes(character varying);

CREATE OR REPLACE FUNCTION dv_guardar_caracterizacion_clientes(_creation_user character varying)
  RETURNS text AS
$BODY$
...
BEGIN
	...
	LOOP
		...
		IF (NOT FOUND )THEN
			...
			FROM dv_caracterizacion_clientes(_idUnidadegocio)
...
ALTER FUNCTION dv_guardar_caracterizacion_clientes(character varying)
  OWNER TO postgres;
