-- Function: eg_movimiento_tsp_paso6(integer, character varying, character varying, character varying)

-- DROP FUNCTION eg_movimiento_tsp_paso6(integer, character varying, character varying, character varying);

CREATE OR REPLACE FUNCTION eg_movimiento_tsp_paso6(_filtro integer, _periodoi character varying, _periodof character varying, _tipoanticipo character varying)
...
_arrCuentasATE varchar[] := '{11050508,13802706}';
_arrCuentasAGA varchar[] := '{1,1}';
...
BEGIN
	...
	LOOP
		...
		/*IF(resultado.cuenta=_arrCuentasATE[2])THEN
			--tipo operacion
...
ALTER FUNCTION eg_movimiento_tsp_paso6(integer, character varying, character varying, character varying)
  OWNER TO postgres;
