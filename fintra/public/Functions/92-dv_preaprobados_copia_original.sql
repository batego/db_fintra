-- Function: dv_preaprobados_copia_original()

-- DROP FUNCTION dv_preaprobados_copia_original();

CREATE OR REPLACE FUNCTION dv_preaprobados_copia_original()
...
ALTER FUNCTION dv_preaprobados_copia_original()
  OWNER TO postgres;
