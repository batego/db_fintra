-- Function: insert_cxp_doc_bank_transfer_efecty(character varying, character varying, numeric, character varying)

-- DROP FUNCTION insert_cxp_doc_bank_transfer_efecty(character varying, character varying, numeric, character varying);

CREATE OR REPLACE FUNCTION insert_cxp_doc_bank_transfer_efecty(cxp_doc character varying, bank character varying, valor_cxp numeric, usuario_crea character varying)
  RETURNS text AS
$BODY$
DECLARE
...
ALTER FUNCTION insert_cxp_doc_bank_transfer_efecty(character varying, character varying, numeric, character varying)
  OWNER TO postgres;
