-- Function: no_saltar_egreso_tsp(text, text, text)

-- DROP FUNCTION no_saltar_egreso_tsp(text, text, text);

CREATE OR REPLACE FUNCTION no_saltar_egreso_tsp(text, text, text)
  RETURNS text AS
$BODY$DECLARE  
...
ALTER FUNCTION no_saltar_egreso_tsp(text, text, text)
  OWNER TO postgres;
