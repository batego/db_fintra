-- Function: sp_seguimientocartera(numeric, character varying, character varying)

-- DROP FUNCTION sp_seguimientocartera(numeric, character varying, character varying);

CREATE OR REPLACE FUNCTION sp_seguimientocartera(periodoasignacion numeric, unidadnegocio character varying, agenteext character varying)
...
ALTER FUNCTION sp_seguimientocartera(numeric, character varying, character varying)
  OWNER TO postgres;
