-- Function: sp_negocioscartas(character varying, character varying)

-- DROP FUNCTION sp_negocioscartas(character varying, character varying);

CREATE OR REPLACE FUNCTION sp_negocioscartas(_linea_negocio character varying, _estados character varying)
...
ALTER FUNCTION sp_negocioscartas(character varying, character varying)
  OWNER TO postgres;
