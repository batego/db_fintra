-- Function: eg_simulador_liquidacion_micro(numeric, integer, date, character varying, character varying)

-- DROP FUNCTION eg_simulador_liquidacion_micro(numeric, integer, date, character varying, character varying);

CREATE OR REPLACE FUNCTION eg_simulador_liquidacion_micro(valornegocio numeric, numcuotas integer, fechaitem date, tipo_cuota character varying, idconvenio character varying)
...
ALTER FUNCTION eg_simulador_liquidacion_micro(numeric, integer, date, character varying, character varying)
  OWNER TO postgres;
