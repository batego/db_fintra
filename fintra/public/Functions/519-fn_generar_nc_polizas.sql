-- Function: fn_generar_nc_polizas(character varying, character varying, character varying)

-- DROP FUNCTION fn_generar_nc_polizas(character varying, character varying, character varying);

CREATE OR REPLACE FUNCTION fn_generar_nc_polizas(
...
--1065004669
				...
				INSERT INTO FIN.CXP_DOC
				    ...
				    'OP','', GET_BANCOCXPM(_CXP.PROVEEDOR),
...
ALTER FUNCTION fn_generar_nc_polizas(character varying, character varying, character varying)
  OWNER TO postgres;
