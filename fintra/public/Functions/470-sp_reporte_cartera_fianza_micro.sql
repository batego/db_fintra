-- Function: sp_reporte_cartera_fianza_micro(integer, character varying)

-- DROP FUNCTION sp_reporte_cartera_fianza_micro(integer, character varying);

CREATE OR REPLACE FUNCTION sp_reporte_cartera_fianza_micro(_linea_negocio integer, _empresa_fianza character varying)
...
BEGIN
   ...
   FOR listaNegocios IN (
			    ...
			    and neg.f_desem != '0099-01-01 00:00:00' --Para que filtre los negocios no desembolsados
...
ALTER FUNCTION sp_reporte_cartera_fianza_micro(integer, character varying)
  OWNER TO postgres;
