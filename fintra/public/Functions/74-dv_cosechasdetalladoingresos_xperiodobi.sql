-- Function: dv_cosechasdetalladoingresos_xperiodobi()

-- DROP FUNCTION dv_cosechasdetalladoingresos_xperiodobi();

CREATE OR REPLACE FUNCTION dv_cosechasdetalladoingresos_xperiodobi()
  RETURNS text AS
$BODY$
...
DELETE FROM cosechas_xunidad_micro where periodo_negocio between _TramoAnterior and PeriodoTramo ;


INSERT INTO cosechas_xunidad_micro(
...
ALTER FUNCTION dv_cosechasdetalladoingresos_xperiodobi()
  OWNER TO postgres;
