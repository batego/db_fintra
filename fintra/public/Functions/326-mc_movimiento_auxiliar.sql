-- Function: mc_movimiento_auxiliar(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying)

-- DROP FUNCTION mc_movimiento_auxiliar(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying);

CREATE OR REPLACE FUNCTION mc_movimiento_auxiliar(empresa character varying, dstrct character varying, periodo character varying, cuenta character varying, cuenta_ri character varying, cuenta_rf character varying, fecha_ri character varying, fecha_rf character varying)
...
ALTER FUNCTION mc_movimiento_auxiliar(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying)
  OWNER TO postgres;
