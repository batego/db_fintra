-- Function: dv_desembolsodeducciones(character varying, character varying, character varying, numeric, numeric, numeric, numeric)

-- DROP FUNCTION dv_desembolsodeducciones(character varying, character varying, character varying, numeric, numeric, numeric, numeric);

CREATE OR REPLACE FUNCTION dv_desembolsodeducciones(_tipodesembolso character varying, _compracartera character varying, _ocupacion character varying, _desembolsocliente numeric, _vlrobligacionescompradas numeric, _cantdeducciones numeric, _plazo numeric)
  RETURNS text AS
$BODY$
...
ALTER FUNCTION dv_desembolsodeducciones(character varying, character varying, character varying, numeric, numeric, numeric, numeric)
  OWNER TO postgres;
