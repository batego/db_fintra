-- Function: sp_seguimientocarteralisim(numeric, character varying, character varying)

-- DROP FUNCTION sp_seguimientocarteralisim(numeric, character varying, character varying);

CREATE OR REPLACE FUNCTION sp_seguimientocarteralisim(periodoasignacion numeric, unidadnegocio character varying, agenteext character varying)
...
BEGIN
	...
	FOR CarteraGeneral IN
		...
		--and negasoc = 'MC04678'
		group by id_convenio, cedula, nombre_cliente, direccion, ciudad, telefono, negasoc, num_doc_fen, vencimiento_mayor, fecha_vencimiento, periodo_vcto, agente
		...
		CarteraGeneral.periodo = PeriodoTramo;
...
ALTER FUNCTION sp_seguimientocarteralisim(numeric, character varying, character varying)
  OWNER TO postgres;
