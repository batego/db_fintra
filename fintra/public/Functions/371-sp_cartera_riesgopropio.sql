-- Function: sp_cartera_riesgopropio(character varying, character varying, character varying, character varying)

-- DROP FUNCTION sp_cartera_riesgopropio(character varying, character varying, character varying, character varying);

CREATE OR REPLACE FUNCTION sp_cartera_riesgopropio(periodo_foto character varying, fch_corte character varying, fch_corte_periodo_anterior character varying, periodo_recaudo character varying)
...
ALTER FUNCTION sp_cartera_riesgopropio(character varying, character varying, character varying, character varying)
  OWNER TO postgres;
