-- Function: dv_extractoduplicado_fenalco(character varying, character varying)

-- DROP FUNCTION dv_extractoduplicado_fenalco(character varying, character varying);

CREATE OR REPLACE FUNCTION dv_extractoduplicado_fenalco(usuario character varying, coduplicado character varying)
  RETURNS text AS
$BODY$
...
ALTER FUNCTION dv_extractoduplicado_fenalco(character varying, character varying)
  OWNER TO postgres;
