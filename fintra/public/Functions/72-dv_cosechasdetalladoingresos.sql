-- Function: dv_cosechasdetalladoingresos(numeric, numeric, character varying)

-- DROP FUNCTION dv_cosechasdetalladoingresos(numeric, numeric, character varying);

CREATE OR REPLACE FUNCTION dv_cosechasdetalladoingresos(periodocolocacionini numeric, periodocolocacionfin numeric, unidadnegocio character varying)
...
ALTER FUNCTION dv_cosechasdetalladoingresos(numeric, numeric, character varying)
  OWNER TO postgres;
