-- Function: eg_liquidador_api_aval(numeric, integer, date, integer, character varying)

-- DROP FUNCTION eg_liquidador_api_aval(numeric, integer, date, integer, character varying);

CREATE OR REPLACE FUNCTION eg_liquidador_api_aval(valornegocio numeric, numcuotas integer, fechaitem date, idconvenio integer, afiliado character varying)
...
ALTER FUNCTION eg_liquidador_api_aval(numeric, integer, date, integer, character varying)
  OWNER TO postgres;
