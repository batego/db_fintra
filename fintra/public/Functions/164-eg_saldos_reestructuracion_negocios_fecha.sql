-- Function: eg_saldos_reestructuracion_negocios_fecha(character varying, character varying)

-- DROP FUNCTION eg_saldos_reestructuracion_negocios_fecha(character varying, character varying);

CREATE OR REPLACE FUNCTION eg_saldos_reestructuracion_negocios_fecha(cod_neg character varying, fecha_corte character varying)
...
ALTER FUNCTION eg_saldos_reestructuracion_negocios_fecha(character varying, character varying)
  OWNER TO postgres;
