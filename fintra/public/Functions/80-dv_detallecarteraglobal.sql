-- Function: dv_detallecarteraglobal(numeric)

-- DROP FUNCTION dv_detallecarteraglobal(numeric);

CREATE OR REPLACE FUNCTION dv_detallecarteraglobal(periodoasignacion numeric)
...
ALTER FUNCTION dv_detallecarteraglobal(numeric)
  OWNER TO postgres;
