-- Function: dv_seguimientocartera2(numeric, character varying, character varying)

-- DROP FUNCTION dv_seguimientocartera2(numeric, character varying, character varying);

CREATE OR REPLACE FUNCTION dv_seguimientocartera2(periodoasignacion numeric, unidadnegocio character varying, agenteext character varying)
...
ALTER FUNCTION dv_seguimientocartera2(numeric, character varying, character varying)
  OWNER TO postgres;
