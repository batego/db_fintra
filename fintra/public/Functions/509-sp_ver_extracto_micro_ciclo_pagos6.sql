-- Function: sp_ver_extracto_micro_ciclo_pagos6(numeric, character varying, numeric, date, character varying, character varying)

-- DROP FUNCTION sp_ver_extracto_micro_ciclo_pagos6(numeric, character varying, numeric, date, character varying, character varying);

CREATE OR REPLACE FUNCTION sp_ver_extracto_micro_ciclo_pagos6(und_negocio numeric, periodo_corriente character varying, nciclo numeric, fecha_corte date, accion character varying, usuario character varying)
...
BEGIN
	...
	SQL = 'select
		...
		WHERE   f.reg_status = ''''
			...
			and f.negasoc in (''MC05725'') --=''TF00004''
...
ALTER FUNCTION sp_ver_extracto_micro_ciclo_pagos6(numeric, character varying, numeric, date, character varying, character varying)
  OWNER TO postgres;
