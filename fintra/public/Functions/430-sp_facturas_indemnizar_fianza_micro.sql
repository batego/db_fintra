-- Function: sp_facturas_indemnizar_fianza_micro(character varying, integer, character varying, integer, character varying, boolean, boolean, boolean)

-- DROP FUNCTION sp_facturas_indemnizar_fianza_micro(character varying, integer, character varying, integer, character varying, boolean, boolean, boolean);

CREATE OR REPLACE FUNCTION sp_facturas_indemnizar_fianza_micro(periodo_corte character varying, _linea_negocio integer, _empresa_fianza character varying, _mora integer, filtro character varying, acelerar_pagare boolean, _gac boolean, _ixm boolean)
...
ALTER FUNCTION sp_facturas_indemnizar_fianza_micro(character varying, integer, character varying, integer, character varying, boolean, boolean, boolean)
  OWNER TO postgres;
