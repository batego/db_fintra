-- Function: sp_plaintextextractconsumo(numeric, numeric, date)

-- DROP FUNCTION sp_plaintextextractconsumo(numeric, numeric, date);

CREATE OR REPLACE FUNCTION sp_plaintextextractconsumo(unidadnegocio numeric, periodoasignacion numeric, fue_generado date)
...
BEGIN
	...
	FOR CarteraExtracto IN
		...
		SELECT
			...
			'CONSUMO'::varchar as linea_producto,
			...
			0::numeric as ktotal
			--select *
		FROM recibo_oficial_pago rop where id_unidad_negocio = unidadnegocio and periodo_rop = periodoasignacion::varchar
		--and negocio in ('FA02482','FA07574','FA10072','FA09186','FA04229','FA07225','FA01983','FA09432','FA05993','FA09140','FA07716','FA09296','FA05161','FA08289','FA04948','FA09161','FA09490','FA09593','FA08392','FA03829','FA02615','FA02897','FA09198','FA02006','FA07120','FA06028','FA09858','FA08258','FA11367','FA10921','FA08311','FA08902','FA05424','FA08580','FA02858','FA07630','FA06871')
		LOOP --FA12031 | FA06518 -- and negocio = 'FA07574'
			...
			FOR ExtractoCategoria IN
				...
				if ( ExtractoCategoria.categoria in ('CAP','AVA','REM') ) then
					--select * from conceptos_recaudo
					--.::#::.
					if ( ExtractoCategoria.descripcion in ('CAPITAL CORRIENTE','AVAL CORRIENTE','REMESA CORRIENTE') ) then
					...
					elsif ( ExtractoCategoria.descripcion in ('CAPITAL VENCIDO','AVAL VENCIDO','REMESA VENCIDO') ) then
	...
	END LOOP;
		...
		where rop.id = dr.id_rop and id_unidad_negocio = 4 and periodo_rop = '201406' and id_rop = 10238 --10238 | 10764 *
		group by
...
ALTER FUNCTION sp_plaintextextractconsumo(numeric, numeric, date)
  OWNER TO postgres;
