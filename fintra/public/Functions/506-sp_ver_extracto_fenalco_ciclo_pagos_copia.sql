-- Function: sp_ver_extracto_fenalco_ciclo_pagos_copia(numeric, character varying, numeric, date, character varying, character varying)

-- DROP FUNCTION sp_ver_extracto_fenalco_ciclo_pagos_copia(numeric, character varying, numeric, date, character varying, character varying);

CREATE OR REPLACE FUNCTION sp_ver_extracto_fenalco_ciclo_pagos_copia(und_negocio numeric, periodo_corriente character varying, nciclo numeric, fecha_corte date, accion character varying, usuario character varying)
...
ALTER FUNCTION sp_ver_extracto_fenalco_ciclo_pagos_copia(numeric, character varying, numeric, date, character varying, character varying)
  OWNER TO postgres;
