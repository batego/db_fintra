-- Function: sp_seguimientocarteraxcliente(numeric, character varying, character varying, character varying)

-- DROP FUNCTION sp_seguimientocarteraxcliente(numeric, character varying, character varying, character varying);

CREATE OR REPLACE FUNCTION sp_seguimientocarteraxcliente(periodoasignacion numeric, unidadnegocio character varying, agenteext character varying, nitcliente character varying)
...
ALTER FUNCTION sp_seguimientocarteraxcliente(numeric, character varying, character varying, character varying)
  OWNER TO postgres;
