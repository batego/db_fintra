-- Function: crear_nc_consumo_fintra(character varying)

-- DROP FUNCTION crear_nc_consumo_fintra(character varying);

CREATE OR REPLACE FUNCTION crear_nc_consumo_fintra(_documento character varying)
  RETURNS text AS
$BODY$
...
ALTER FUNCTION crear_nc_consumo_fintra(character varying)
  OWNER TO postgres;
