-- Function: dv_reporte_aplicacion_pagos_negocio(character varying)

-- DROP FUNCTION dv_reporte_aplicacion_pagos_negocio(character varying);

CREATE OR REPLACE FUNCTION dv_reporte_aplicacion_pagos_negocio(negocio character varying)
...
ALTER FUNCTION dv_reporte_aplicacion_pagos_negocio(character varying)
  OWNER TO postgres;
