-- Function: sp_negociosinteresvencimiento()

-- DROP FUNCTION sp_negociosinteresvencimiento();

CREATE OR REPLACE FUNCTION sp_negociosinteresvencimiento()
...
ALTER FUNCTION sp_negociosinteresvencimiento()
  OWNER TO postgres;
