-- Function: sp_ver_extracto_fenalco_ciclo_pagos(numeric, character varying, numeric, date, character varying, character varying)

-- DROP FUNCTION sp_ver_extracto_fenalco_ciclo_pagos(numeric, character varying, numeric, date, character varying, character varying);

CREATE OR REPLACE FUNCTION sp_ver_extracto_fenalco_ciclo_pagos(und_negocio numeric, periodo_corriente character varying, nciclo numeric, fecha_corte date, accion character varying, usuario character varying)
...
BEGIN
	...
	SQL = 'select
		...
		WHERE  f.reg_status = ''''
			...
			--and f.negasoc in (''FA34279'') --(''FA18901'',''FA18900'')
...
ALTER FUNCTION sp_ver_extracto_fenalco_ciclo_pagos(numeric, character varying, numeric, date, character varying, character varying)
  OWNER TO postgres;
