-- Function: dv_detallecarteraxsancion(numeric, character varying, character varying)

-- DROP FUNCTION dv_detallecarteraxsancion(numeric, character varying, character varying);

CREATE OR REPLACE FUNCTION dv_detallecarteraxsancion(periodoasignacion numeric, unidadnegocio character varying, negocioref character varying)
...
ALTER FUNCTION dv_detallecarteraxsancion(numeric, character varying, character varying)
  OWNER TO postgres;
