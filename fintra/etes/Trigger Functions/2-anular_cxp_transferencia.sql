-- Function: etes.anular_cxp_transferencia()

-- DROP FUNCTION etes.anular_cxp_transferencia();

CREATE OR REPLACE FUNCTION etes.anular_cxp_transferencia()
  RETURNS "trigger" AS
$BODY$
DECLARE
...
BEGIN
	...
	IF(producto ='ANT00002' AND NEW.reg_status='A' AND OLD.reg_status='') THEN
		...
		RAISE NOTICE 'FUNCION ANULAR CXP TRANSFERENCIA MANIFIESTO %',producto ;
...
ALTER FUNCTION etes.anular_cxp_transferencia()
  OWNER TO postgres;
