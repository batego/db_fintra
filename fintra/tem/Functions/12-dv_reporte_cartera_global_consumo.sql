-- Function: tem.dv_reporte_cartera_global_consumo()

-- DROP FUNCTION tem.dv_reporte_cartera_global_consumo();

CREATE OR REPLACE FUNCTION tem.dv_reporte_cartera_global_consumo()
...
ALTER FUNCTION tem.dv_reporte_cartera_global_consumo()
  OWNER TO postgres;
