-- Function: tem.dv_reporte_cartera_global(character varying)

-- DROP FUNCTION tem.dv_reporte_cartera_global(character varying);

CREATE OR REPLACE FUNCTION tem.dv_reporte_cartera_global(unidadnegocio_ character varying)
...
ALTER FUNCTION tem.dv_reporte_cartera_global(character varying)
  OWNER TO postgres;
