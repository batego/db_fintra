-- Function: tem.dv_reporte_cartera_global_automotor_codeudor()

-- DROP FUNCTION tem.dv_reporte_cartera_global_automotor_codeudor();

CREATE OR REPLACE FUNCTION tem.dv_reporte_cartera_global_automotor_codeudor()
...
$BODY$
	...
	BEGIN
		...
		FOR CarteraGeneral IN
			...
			LEFT JOIN SOLICITUD_PERSONA SP ON (SP.NUMERO_SOLICITUD=SA.NUMERO_SOLICITUD AND SP.TIPO in ('S'))
...
ALTER FUNCTION tem.dv_reporte_cartera_global_automotor_codeudor()
  OWNER TO postgres;
