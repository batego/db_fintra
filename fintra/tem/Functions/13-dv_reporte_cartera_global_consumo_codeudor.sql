-- Function: tem.dv_reporte_cartera_global_consumo_codeudor()

-- DROP FUNCTION tem.dv_reporte_cartera_global_consumo_codeudor();

CREATE OR REPLACE FUNCTION tem.dv_reporte_cartera_global_consumo_codeudor()
		...
		FOR CarteraGeneral IN
			...
			WHERE FRA.DSTRCT = 'FINV'
					   ...
					   -- AND NEGOCIOS.COD_NEG = 'FA32209'
					    ...
					    AND NEGOCIO_REL_GPS = ''
					    AND UN.ID in (4,10,30) AND UN.REF_4 !=''
...
ALTER FUNCTION tem.dv_reporte_cartera_global_consumo_codeudor()
  OWNER TO postgres;
