-- Function: tem.dv_reporte_cartera_global_educativo()

-- DROP FUNCTION tem.dv_reporte_cartera_global_educativo();

CREATE OR REPLACE FUNCTION tem.dv_reporte_cartera_global_educativo()
...
ALTER FUNCTION tem.dv_reporte_cartera_global_educativo()
  OWNER TO postgres;
