-- Table: business_intelligence.eg_movimiento_tsp_paso_aet

-- DROP TABLE business_intelligence.eg_movimiento_tsp_paso_aet;

CREATE TABLE business_intelligence.eg_movimiento_tsp_paso_aet
(
  id serial NOT NULL,
...
ALTER TABLE business_intelligence.eg_movimiento_tsp_paso_aet
  OWNER TO postgres;
