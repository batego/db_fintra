-- Table: business_intelligence.eg_movimiento_tsp_paso_ext

-- DROP TABLE business_intelligence.eg_movimiento_tsp_paso_ext;

CREATE TABLE business_intelligence.eg_movimiento_tsp_paso_ext
(
  id serial NOT NULL,
...
ALTER TABLE business_intelligence.eg_movimiento_tsp_paso_ext
  OWNER TO postgres;
