-- Function: business_intelligence.eg_insert_pyg()

-- DROP FUNCTION business_intelligence.eg_insert_pyg();

CREATE OR REPLACE FUNCTION business_intelligence.eg_insert_pyg()
  RETURNS text AS
$BODY$
DECLARE
  result text := 'OK';
...
ALTER FUNCTION business_intelligence.eg_insert_pyg()
  OWNER TO postgres;
