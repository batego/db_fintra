-- Function: recaudo.sp_aplicarpagocartera2(_entidadrecaudadora integer,_fecharecaudo  date,_loterecaudo  integer,_idetalle_recaudo  integer,codrop  integer,generarixmgac  boolean,tipoingreso  character varying,formadeingreso  character varying,cuentatwochar  character varying,unidadnegocio  integer,usersesion  character varying,cmcdoc  character varying,cuentacabingreso  character varying,cuentadetingreso  character varying,cuentacarterafrom  character varying,cuentaixm  character varying,cuentagac  character varying)

-- DROP FUNCTION  recaudo.sp_aplicarpagocartera2(_entidadrecaudadora integer,_fecharecaudo  date,_loterecaudo  integer,_idetalle_recaudo  integer,codrop  integer,generarixmgac  boolean,tipoingreso  character varying,formadeingreso  character varying,cuentatwochar  character varying,unidadnegocio  integer,usersesion  character varying,cmcdoc  character varying,cuentacabingreso  character varying,cuentadetingreso  character varying,cuentacarterafrom  character varying,cuentaixm  character varying,cuentagac  character varying)

CREATE OR REPLACE FUNCTION recaudo.sp_aplicarpagocartera2(_entidadrecaudadora integer,_fecharecaudo  date,_loterecaudo  integer,_idetalle_recaudo  integer,codrop  integer,generarixmgac  boolean,tipoingreso  character varying,formadeingreso  character varying,cuentatwochar  character varying,unidadnegocio  integer,usersesion  character varying,cmcdoc  character varying,cuentacabingreso  character varying,cuentadetingreso  character varying,cuentacarterafrom  character varying,cuentaixm  character varying,cuentagac  character varying)
RETURNS text AS
$BODY$
	...
	IF ( GenerarIxMGaC ) THEN
		...
		LOOP
			IF FOUND THEN
				...
				VALUES('FINV','ICA',NumeroIngreso,ItemDetalleIngreso,RoP.cedula,
...
ALTER FUNCTION recaudo.sp_aplicarpagocartera2 (_entidadrecaudadora integer,_fecharecaudo  date,_loterecaudo  integer,_idetalle_recaudo  integer,codrop  integer,generarixmgac  boolean,tipoingreso  character varying,formadeingreso  character varying,cuentatwochar  character varying,unidadnegocio  integer,usersesion  character varying,cmcdoc  character varying,cuentacabingreso  character varying,cuentadetingreso  character varying,cuentacarterafrom  character varying,cuentaixm  character varying,cuentagac  character varying)
OWNER TO postgres;
