-- Function: recaudo.sp_aplicacionpago2(integer, integer, integer, character varying, date, integer)

-- DROP FUNCTION recaudo.sp_aplicacionpago2(integer, integer, integer, character varying, date, integer);

CREATE OR REPLACE FUNCTION recaudo.sp_aplicacionpago2(loterecaudo integer, idetalle_recaudo integer, codrop integer, usuario character varying, fecharecaudo date, entidadrecaudadora integer)
  RETURNS text AS
$BODY$
...
ALTER FUNCTION recaudo.sp_aplicacionpago2(integer, integer, integer, character varying, date, integer)
  OWNER TO postgres;
