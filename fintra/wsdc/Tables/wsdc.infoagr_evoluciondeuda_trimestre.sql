-- Table: wsdc.infoagr_evoluciondeuda_trimestre

-- DROP TABLE wsdc.infoagr_evoluciondeuda_trimestre;

CREATE TABLE wsdc.infoagr_evoluciondeuda_trimestre
(
  id serial NOT NULL,
  ...
  mesesmoramaxima character varying NOT NULL DEFAULT ''::character varying,
...
ALTER TABLE wsdc.infoagr_evoluciondeuda_trimestre
  OWNER TO postgres;
