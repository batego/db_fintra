-- Table: wsdc.infoagr_saldos_mes

-- DROP TABLE wsdc.infoagr_saldos_mes;

CREATE TABLE wsdc.infoagr_saldos_mes
(
  id serial NOT NULL,
  ...
  saldototalmora character varying NOT NULL DEFAULT ''::character varying,
...
ALTER TABLE wsdc.infoagr_saldos_mes
  OWNER TO postgres;
