-- Table: administrativo.control_indemnizacion_fenalco_1

-- DROP TABLE administrativo.control_indemnizacion_fenalco_1;

CREATE TABLE administrativo.control_indemnizacion_fenalco_1
(
  id integer NOT NULL,
...
ALTER TABLE administrativo.control_indemnizacion_fenalco_1
  OWNER TO postgres;
