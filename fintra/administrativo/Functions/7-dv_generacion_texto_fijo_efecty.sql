-- Function: administrativo.dv_generacion_texto_fijo_efecty()

-- DROP FUNCTION administrativo.dv_generacion_texto_fijo_efecty();

CREATE OR REPLACE FUNCTION administrativo.dv_generacion_texto_fijo_efecty()
  RETURNS text AS
$BODY$
...
begin
	...
	--raise notice '_info_negocio %',array_to_string(negocio, ',');
	for _info_negocio in
		...
		and n.cod_neg =  'MC12602' and p.cedula_cuenta = '1066178533'--Quemar el negocio y la cedula para que se genere el archivo de ese unico negocio
		and cxp.cheque !=''
...
ALTER FUNCTION administrativo.dv_generacion_texto_fijo_efecty()
  OWNER TO postgres;
