-- Table: con.mc_inversionistas____

-- DROP TABLE con.mc_inversionistas____;

CREATE TABLE con.mc_inversionistas____
(
...
ALTER TABLE con.mc_inversionistas____
  OWNER TO postgres;
COMMENT ON TABLE con.mc_inversionistas____
