-- Table: con.mc_cd_endoso____

-- DROP TABLE con.mc_cd_endoso____;

CREATE TABLE con.mc_cd_endoso____
(
  ...
  mc_____secuinte__dcd____b integer NOT NULL,
...
ALTER TABLE con.mc_cd_endoso____
  OWNER TO postgres;
COMMENT ON TABLE con.mc_cd_endoso____
  IS 'MOVIMIENTO CONTABLES. INTERFACE APOTEOSYS';
