-- Table: con.mc_sl_fac_sel

-- DROP TABLE con.mc_sl_fac_sel;

CREATE TABLE con.mc_sl_fac_sel
(
...
ALTER TABLE con.mc_sl_fac_sel
  OWNER TO postgres;
COMMENT ON TABLE con.mc_sl_fac_sel
  IS 'MOVIMIENTO CONTABLES SELECTRIK. INTERFACE APOTEOSYS';
