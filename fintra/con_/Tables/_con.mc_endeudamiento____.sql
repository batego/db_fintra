-- Table: con.mc_endeudamiento____

-- DROP TABLE con.mc_endeudamiento____;

CREATE TABLE con.mc_endeudamiento____
(
...
ALTER TABLE con.mc_endeudamiento____
  OWNER TO postgres;
COMMENT ON TABLE con.mc_endeudamiento____
