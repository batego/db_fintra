-- Table: con.facturas_endoso

-- DROP TABLE con.facturas_endoso;

CREATE TABLE con.facturas_endoso
(
...
ALTER TABLE con.facturas_endoso
  OWNER TO postgres;
GRANT ALL ON TABLE con.facturas_endoso TO postgres;
GRANT SELECT ON TABLE con.facturas_endoso TO msoto;
