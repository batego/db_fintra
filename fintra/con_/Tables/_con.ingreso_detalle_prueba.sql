-- Table: con.ingreso_detalle_prueba

-- DROP TABLE con.ingreso_detalle_prueba;

CREATE TABLE con.ingreso_detalle_prueba
(
...
ALTER TABLE con.ingreso_detalle_prueba
  OWNER TO postgres;
GRANT ALL ON TABLE con.ingreso_detalle_prueba TO postgres;
GRANT SELECT ON TABLE con.ingreso_detalle_prueba TO msoto;
