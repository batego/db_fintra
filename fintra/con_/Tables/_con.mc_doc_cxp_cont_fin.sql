-- Table: con.mc_doc_cxp_cont_fin

-- DROP TABLE con.mc_doc_cxp_cont_fin;

CREATE TABLE con.mc_doc_cxp_cont_fin
(
...
ALTER TABLE con.mc_doc_cxp_cont_fin
  OWNER TO postgres;
COMMENT ON TABLE con.mc_doc_cxp_cont_fin
  IS 'DOCUMENTOS CXP CONTRATISTAS EN FINTRA INTERFACE APOTEOSYS';
