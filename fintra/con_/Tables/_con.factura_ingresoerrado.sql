-- Table: con.factura_ingresoerrado

-- DROP TABLE con.factura_ingresoerrado;

CREATE TABLE con.factura_ingresoerrado
(
...
ALTER TABLE con.factura_ingresoerrado
  OWNER TO postgres;
GRANT ALL ON TABLE con.factura_ingresoerrado TO postgres;
GRANT SELECT ON TABLE con.factura_ingresoerrado TO msoto;
