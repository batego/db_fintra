-- Table: con.mc_libranza____

-- DROP TABLE con.mc_libranza____;

CREATE TABLE con.mc_libranza____
(
...
ALTER TABLE con.mc_libranza____
  OWNER TO postgres;
COMMENT ON TABLE con.mc_libranza____
