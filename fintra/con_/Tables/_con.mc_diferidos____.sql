-- Table: con.mc_diferidos____

-- DROP TABLE con.mc_diferidos____;

CREATE TABLE con.mc_diferidos____
(
...
ALTER TABLE con.mc_diferidos____
  OWNER TO postgres;
COMMENT ON TABLE con.mc_diferidos____
