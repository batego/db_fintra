-- Function: con.sp_insert_table_mc_doc_cxp_cont_fintra(con.type_insert_mc)

-- DROP FUNCTION con.sp_insert_table_mc_doc_cxp_cont_fintra(con.type_insert_mc);

CREATE OR REPLACE FUNCTION con.sp_insert_table_mc_doc_cxp_cont_fintra(mctype con.type_insert_mc)
  RETURNS text AS
$BODY$
...
/*****************************************************
*INSERTA EN LA TABLA mc_doc_cxp_cont_fin A PARTIR DE UN TYPE      *
*autor:@WSIADO				     *
*fecha: 2017-11-16				     *
******************************************************/

INSERT INTO con.mc_doc_cxp_cont_fin(
...
ALTER FUNCTION con.sp_insert_table_mc_doc_cxp_cont_fintra(con.type_insert_mc)
  OWNER TO postgres;
