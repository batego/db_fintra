-- Function: con.sp_insert_table_mc_inversionistas____(con.type_insert_mc)

-- DROP FUNCTION con.sp_insert_table_mc_inversionistas____(con.type_insert_mc);

CREATE OR REPLACE FUNCTION con.sp_insert_table_mc_inversionistas____(mctype con.type_insert_mc)
  RETURNS text AS
$BODY$
...
/*****************************************************
*INSERTA EN LA TABLA SP_INSERT_TABLE_MC_INVERSIONISTAS____ A PARTIR DE UN TYPE      *
*autor:@jzapata				     *
*fecha: 2017-08-04				     *
******************************************************/

INSERT INTO con.mc_inversionistas____(
...
ALTER FUNCTION con.sp_insert_table_mc_inversionistas____(con.type_insert_mc)
  OWNER TO postgres;
