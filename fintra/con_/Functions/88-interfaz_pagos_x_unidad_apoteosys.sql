-- Function: con.interfaz_pagos_x_unidad_apoteosys(character varying, character varying)

-- DROP FUNCTION con.interfaz_pagos_x_unidad_apoteosys(character varying, character varying);

CREATE OR REPLACE FUNCTION con.interfaz_pagos_x_unidad_apoteosys(_periodo character varying, _unidadnego character varying)
  RETURNS text AS
$BODY$
...
BEGIN
	...
	FOR r_ingreso IN
		...
		FROM
			--con.eg_recaudo_xunidad('201708', 'LIBRANZA') erx
	...
	LOOP
		...
		FOR r_asiento IN
			...
			SELECT
				ing.num_ingreso,
				CASE
					WHEN ing.cuenta='28150531' THEN 'I010130014205'
					WHEN ing.cuenta='28150530' THEN 'I010140014205'
					WHEN ing.cuenta='28150533' THEN 'I010300014205'
				ELSE
					ing.cuenta END AS cuenta,
				--ing.cuenta,
				ing.tipo_documento,
				ing.creation_date,
				ing.periodo,
...
ALTER FUNCTION con.interfaz_pagos_x_unidad_apoteosys(character varying, character varying)
  OWNER TO postgres;
