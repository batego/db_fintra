-- Function: con.sp_insert_table_mc_sl_fac_sel(con.type_insert_mc)

-- DROP FUNCTION con.sp_insert_table_mc_sl_fac_sel(con.type_insert_mc);

CREATE OR REPLACE FUNCTION con.sp_insert_table_mc_sl_fac_sel(mctype con.type_insert_mc)
  RETURNS text AS
$BODY$
...
/*****************************************************
*INSERTA EN LA TABLA mc_sl_fac_sel A PARTIR DE UN TYPE      *
*autor:@WSIADO				     *
*fecha: 2017-11-16				     *
******************************************************/

INSERT INTO con.mc_sl_fac_sel(
...
ALTER FUNCTION con.sp_insert_table_mc_sl_fac_sel(con.type_insert_mc)
  OWNER TO postgres;
