-- Function: con.interfaz_egresos_fe_apoteosys()

-- DROP FUNCTION con.interfaz_egresos_fe_apoteosys();

CREATE OR REPLACE FUNCTION con.interfaz_egresos_fe_apoteosys()
  RETURNS text AS
$BODY$
...
BEGIN
	...
	LOOP
		...
		LOOP
			...
			IF(CON.OBTENER_HOMOLOGACION_APOTEOSYS('EGR_FE_FINT',EGRESO_.TIPO_DOCUMENTO, INFOITEMS_.CUENTA, EGRESO_.AGENCIA, 6)='S')THEN
			...
			MCTYPE.MC_____CODIGO____CPC____B := CON.OBTENER_HOMOLOGACION_APOTEOSYS('EGR_FE_FINT', EGRESO_.TIPO_DOCUMENTO, INFOITEMS_.CUENTA,EGRESO_.AGENCIA, 1);
			MCTYPE.MC_____CODIGO____CU_____B := CON.OBTENER_HOMOLOGACION_APOTEOSYS('EGR_FE_FINT', EGRESO_.TIPO_DOCUMENTO, INFOITEMS_.CUENTA,EGRESO_.AGENCIA, 2);
			...
			MCTYPE.MC_____CODIGO____DS_____B := CON.OBTENER_HOMOLOGACION_APOTEOSYS('EGR_FE_FINT',EGRESO_.TIPO_DOCUMENTO, INFOITEMS_.CUENTA,EGRESO_.AGENCIA, 3);
			IF(CON.OBTENER_HOMOLOGACION_APOTEOSYS('EGR_FE_FINT', EGRESO_.TIPO_DOCUMENTO, INFOITEMS_.CUENTA,EGRESO_.AGENCIA, 4)='S')THEN
				MCTYPE.MC_____NUMDOCSOP_B := INFOITEMS_.DOCUMENTO;
			ELSE
				MCTYPE.MC_____NUMDOCSOP_B := '';
			END IF;

			IF(CON.OBTENER_HOMOLOGACION_APOTEOSYS('EGR_FE_FINT', EGRESO_.TIPO_DOCUMENTO, INFOITEMS_.CUENTA, EGRESO_.AGENCIA, 5)::INT=1)THEN
...
ALTER FUNCTION con.interfaz_egresos_fe_apoteosys()
  OWNER TO postgres;
