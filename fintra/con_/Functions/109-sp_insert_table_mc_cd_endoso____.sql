-- Function: con.sp_insert_table_mc_cd_endoso____(con.type_insert_mc)

-- DROP FUNCTION con.sp_insert_table_mc_cd_endoso____(con.type_insert_mc);

CREATE OR REPLACE FUNCTION con.sp_insert_table_mc_cd_endoso____(mctype con.type_insert_mc)
  RETURNS text AS
$BODY$
...
INSERT INTO con.mc_cd_endoso____ (
...
ALTER FUNCTION con.sp_insert_table_mc_cd_endoso____(con.type_insert_mc)
  OWNER TO postgres;
