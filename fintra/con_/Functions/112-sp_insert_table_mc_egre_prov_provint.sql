-- Function: con.sp_insert_table_mc_egre_prov_provint(con.type_insert_mc)

-- DROP FUNCTION con.sp_insert_table_mc_egre_prov_provint(con.type_insert_mc);

CREATE OR REPLACE FUNCTION con.sp_insert_table_mc_egre_prov_provint(mctype con.type_insert_mc)
  RETURNS text AS
$BODY$
...
/*****************************************************
*INSERTA EN LA TABLA mc_egre_prov_provint A PARTIR DE UN TYPE      *
*autor:@BTERRAZA				     *
*fecha: 2017-11-16				     *
******************************************************/

INSERT INTO con.mc_egre_prov_provint(
...
ALTER FUNCTION con.sp_insert_table_mc_egre_prov_provint(con.type_insert_mc)
  OWNER TO postgres;
