-- Function: con.sp_insert_table_mc_fianza____(con.type_insert_mc)

-- DROP FUNCTION con.sp_insert_table_mc_fianza____(con.type_insert_mc);

CREATE OR REPLACE FUNCTION con.sp_insert_table_mc_fianza____(mctype con.type_insert_mc)
  RETURNS text AS
$BODY$
...
ALTER FUNCTION con.sp_insert_table_mc_fianza____(con.type_insert_mc)
  OWNER TO postgres;
