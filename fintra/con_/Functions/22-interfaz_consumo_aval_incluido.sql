-- Function: con.interfaz_consumo_aval_incluido()

-- DROP FUNCTION con.interfaz_consumo_aval_incluido();

CREATE OR REPLACE FUNCTION con.interfaz_consumo_aval_incluido()
  RETURNS text AS
$BODY$
...
DECLARE
 ...
 /************************************************
  *DESCRIPCION: ESTA FUNCION BUSCA TODOS LO NEGOCIOS CONSUMO CON AVALES INCLUIDOS.
  *AUTOR:=@MMEDINA
...
BEGIN
	...
	LOOP
		...
		FOR INFOITEMS_ IN
			...
			TIPO_IDEN, E.CODIGO_DANE2, D.NOMBRE1, D.NOMBRE2, D.APELLIDO1, D.APELLIDO2
...
ALTER FUNCTION con.interfaz_consumo_aval_incluido()
  OWNER TO postgres;
