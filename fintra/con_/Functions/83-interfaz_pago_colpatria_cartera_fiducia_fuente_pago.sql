-- Function: con.interfaz_pago_colpatria_cartera_fiducia_fuente_pago()

-- DROP FUNCTION con.interfaz_pago_colpatria_cartera_fiducia_fuente_pago();

CREATE OR REPLACE FUNCTION con.interfaz_pago_colpatria_cartera_fiducia_fuente_pago()
  RETURNS text AS
$BODY$
...
BEGIN
	...
	/**
	SELECT CON.INTERFAZ_PAGO_COLPATRIA_CARTERA_FIDUCIA_FUENTE_PAGO()
...
ALTER FUNCTION con.interfaz_pago_colpatria_cartera_fiducia_fuente_pago()
  OWNER TO postgres;
