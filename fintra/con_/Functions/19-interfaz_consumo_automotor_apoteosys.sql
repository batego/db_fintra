-- Function: con.interfaz_consumo_automotor_apoteosys(character varying, character varying, character varying, character varying, date)

-- DROP FUNCTION con.interfaz_consumo_automotor_apoteosys(character varying, character varying, character varying, character varying, date);

CREATE OR REPLACE FUNCTION con.interfaz_consumo_automotor_apoteosys(negocio_padre character varying, secuencia_g character varying, tipo_doc_ap character varying, clase_documento character varying, fecha_padre date)
  RETURNS text AS
$BODY$
...
ALTER FUNCTION con.interfaz_consumo_automotor_apoteosys(character varying, character varying, character varying, character varying, date)
  OWNER TO postgres;
