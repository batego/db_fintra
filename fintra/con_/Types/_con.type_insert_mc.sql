-- Type: con.type_insert_mc

-- DROP TYPE con.type_insert_mc;

CREATE TYPE con.type_insert_mc AS
   (mc_____codigo____contab_b character varying(4),
    mc_____codigo____td_____b character varying(4),
    mc_____codigo____cd_____b character varying(4),
    mc_____secuinte__dcd____b integer,
    mc_____fecha_____b timestamp without time zone,
    mc_____numero____b character varying(26),
    mc_____secuinte__b integer,
    ...
    mc_____fechemis__b timestamp without time zone,
    mc_____fechvenc__b timestamp without time zone,
    mc_____fechdesc__b timestamp without time zone,
    ...
    mc_____fectascam_b timestamp without time zone,
    ...
    mc_____fechorcre_b timestamp without time zone,
    mc_____autocrea__b character varying(50),
    mc_____fehoulmo__b timestamp without time zone,
    ...
    mc_____numero_oper_b character varying(20),
