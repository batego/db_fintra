-- Table: apicredit.pre_liquidacion_creditos_aval

-- DROP TABLE apicredit.pre_liquidacion_creditos_aval;

CREATE TABLE apicredit.pre_liquidacion_creditos_aval
(
  id serial NOT NULL,
...
ALTER TABLE apicredit.pre_liquidacion_creditos_aval
  OWNER TO postgres;
