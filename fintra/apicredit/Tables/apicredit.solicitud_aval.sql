-- Table: apicredit.solicitud_aval

-- DROP TABLE apicredit.solicitud_aval;

CREATE TABLE apicredit.solicitud_aval
(
  ...
  asesor character varying(10) NOT NULL DEFAULT ''::character varying,
...
ALTER TABLE apicredit.solicitud_aval
  OWNER TO postgres;
