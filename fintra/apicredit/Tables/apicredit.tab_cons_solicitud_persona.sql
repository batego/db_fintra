-- Table: apicredit.tab_cons_solicitud_persona

-- DROP TABLE apicredit.tab_cons_solicitud_persona;

CREATE TABLE apicredit.tab_cons_solicitud_persona
(
  id serial NOT NULL,
...
ALTER TABLE apicredit.tab_cons_solicitud_persona
  OWNER TO postgres;
