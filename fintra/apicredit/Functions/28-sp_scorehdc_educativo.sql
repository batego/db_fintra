-- Function: apicredit.sp_scorehdc_educativo(integer, character varying)

-- DROP FUNCTION apicredit.sp_scorehdc_educativo(integer, character varying);

CREATE OR REPLACE FUNCTION apicredit.sp_scorehdc_educativo(_numero_solicitud integer, _huella character varying)
  RETURNS text AS
$BODY$
...
ALTER FUNCTION apicredit.sp_scorehdc_educativo(integer, character varying)
  OWNER TO postgres;
