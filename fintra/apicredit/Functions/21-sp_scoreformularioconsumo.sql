-- Function: apicredit.sp_scoreformularioconsumo(integer)

-- DROP FUNCTION apicredit.sp_scoreformularioconsumo(integer);

CREATE OR REPLACE FUNCTION apicredit.sp_scoreformularioconsumo(_numero_solicitud integer)
  RETURNS text AS
$BODY$
...
ALTER FUNCTION apicredit.sp_scoreformularioconsumo(integer)
  OWNER TO postgres;
